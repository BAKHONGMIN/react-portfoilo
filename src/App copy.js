...
//   let [SubmenuText,SubmenuTextch] = useState(['현명한 박홍민', '똑똑한 박홍민', '한결같은 박홍민', '진실된 박홍민', '변하지 않는 박홍민', '카멜레온 같은 박홍민']);
            ...
            <ul>
                ...
                <li className="input">
                    ...
                    <ul className="submenu">
                        {/* <li>{submenu}<a href="" className="submenutext">{SubmenuText[0]}</a></li>
                        <li>{submenu}<a href="" className="submenutext">{SubmenuText[1]}</a></li>
                        <li>{submenu}<a href="" className="submenutext">{SubmenuText[2]}</a></li>
                        <li>{submenu}<a href="" className="submenutext">{SubmenuText[3]}</a></li>
                        <li>{submenu}<a href="" className="submenutext">{SubmenuText[4]}</a></li>
                        <li>{submenu}<a href="" className="submenutext">{SubmenuText[5]}</a></li> */}
                        <div> {nameList} </div>
                    </ul> 
                </li>
